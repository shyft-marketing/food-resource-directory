...
jQuery(document).ready(function($) {
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.success) {
                    ...
                    window.location.href = '<?php echo add_query_arg('step', 'preview', admin_url('admin.php?page=food-resource-directory-import')); ?>';
                } else {
                    $('#frd-upload-result').html(
    ...
    $(document).on('click', '#frd-confirm-import', function() {
        ...
        $.post(ajaxurl, {
            ...
            if (response.success) {
                window.location.href = '<?php echo add_query_arg('step', 'results', admin_url('admin.php?page=food-resource-directory-import')); ?>';
            } else {
